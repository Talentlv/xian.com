...
<html>
	<head>
		...
		$(function(){
			...
			//动态生成
			$('.khzx-menu dl dd a[res=1004]').addClass('active').parent().parent().addClass('active');
		});
		</script>
		...
		<div class="wrap">
			<div class="wl240 bgfff khzx-menu">
				...
				<dl>
					...
					<dd><a res="1004" href="list.php">我的收藏</a></dd>
					<dd><a res="1005" href="../comment/list.php">我的评价</a></dd>
				</dl>
			...
			<div class="wr935 bgfff">
				<div class="member-body">
					...
					?>
						...
						<div class="error-box box-info">对不起，当前没有收藏任何鲜花！</div>
					</div>
					<?php
					}
					else{
